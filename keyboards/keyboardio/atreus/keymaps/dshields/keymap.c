...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FUN] = LAYOUT(
        ...
        KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,                    _______, MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR,
        _______, _______, _______, _______, _______, QK_BOOT, EE_CLR,  KC_VOLD, KC_VOLU, MS_BTN1, MS_BTN2, MS_BTN3,
